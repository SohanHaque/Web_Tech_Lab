...
if(isset($_POST['continue'])) {
    ...
    $_SESSION['d.ammount'] = $ammount;
    $_SESSION['otherAmmount'] = $otherAmmount;
    $_SESSION['interrested'] = $interrested;
    $_SESSION['c.card1'] = $card1;
    $_SESSION['c.card2'] = $card2;
    ...
    $_SESSION['con.postmail2'] = $postmail2;
    $_SESSION['con.email2'] = $email232;
    $_SESSION['con.postmail2'] = $postmail2;
...
<body>
    <?php
       ...
       echo $_SESSION['d.ammount']."<br>"; 
       echo $_SESSION['otherAmmount']."<br>"; 
       echo $_SESSION['interrested']."<br>"; 
       echo $_SESSION['c.card1']."<br>"; 
       echo $_SESSION['c.card2']."<br>"; 
       ...
       echo $_SESSION['con.postmail2']."<br>"; 
       echo $_SESSION['con.email2']."<br>"; 
       echo $_SESSION['con.postmail2']."<br>"; 
